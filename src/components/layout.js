    ...
    if (location.pathname === rootPath) {
      ...
      header = (
        <div className="homePageHeader">
          ...
          <p>I am graduating with a <strong>Master's in Computer Science <span role="img" aria-label="woman student">👩‍🎓</span></strong> from Old Dominion University in December 2019, 
          ...
          You are welcome to read along as I jot down a few pointers, but if you want to talk about the House of The Dragon <span role="img" aria-label="dragon">🐉</span>, I’m totally fine with that too.</p>
